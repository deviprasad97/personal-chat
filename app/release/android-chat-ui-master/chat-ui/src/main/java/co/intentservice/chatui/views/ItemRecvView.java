...
public class ItemRecvView extends MessageView {
    ...
    /**
     * Method to set the receiver's profile icon that you want to use in your chat view.
     * @param uri The background that you want to be displayed.
     */
    public void setProfileIcon(Uri uri) {
